...
public class PluginConfig {
    ...
    public static class DefaultConfig {
        ...
        // Indicates whether the code output by asset is compatible with the
        ...
        public static class js {
            ...
            public static final String compressedDir = "/public/javascripts/asset/";
        ...
        public static class css {
            ...
            public static final String compressedDir = "/public/stylesheets/asset/";
    ...
    public static void readConfig() {
        AssetLogger.trace("Loading asset plugin configuration");

        // asset options
        enabled = ConfigHelper.getBoolean("asset.enabled", DefaultConfig.enabled);
        String cacheDefault = DefaultConfig.cache.toString();
        cache = CachingStrategy.parse(ConfigHelper.getString("asset.cache", cacheDefault));
        cacheClearEnabled = ConfigHelper.getBoolean("asset.cache.clearEnabled",
                DefaultConfig.cacheClearEnabled);
        inMemoryStorage = ConfigHelper.getBoolean("asset.inMemoryStorage", DefaultConfig.inMemoryStorage);
        compressionKeyStorageTime = ConfigHelper.getString("asset.key.lifetime",
                DefaultConfig.compressionKeyStorageTime);
        maxCompressionTimeMillis = ConfigHelper.getInt("asset.compression.maxTimeMillis",
                DefaultConfig.maxCompressionTimeMillis);
        htmlCompatible = ConfigHelper.getBoolean("asset.htmlCompatible",
                DefaultConfig.htmlCompatible);
        contentHostingDomain = ConfigHelper.getString("asset.contentHostingDomain",
        		DefaultConfig.contentHostingDomain);

        css.srcDir = ConfigHelper.getString("asset.css.sourceDir", DefaultConfig.css.srcDir);
        css.compressedDir = ConfigHelper.getString("asset.css.outputDir",
                DefaultConfig.css.compressedDir);

        js.srcDir = ConfigHelper.getString("asset.js.sourceDir", DefaultConfig.js.srcDir);
        js.compressedDir = ConfigHelper.getString("asset.js.outputDir",
                DefaultConfig.js.compressedDir);

        // YUI options
        css.lineBreak = ConfigHelper.getInt("asset.yui.css.lineBreak", DefaultConfig.css.lineBreak);
        js.lineBreak = ConfigHelper.getInt("asset.yui.js.lineBreak", DefaultConfig.js.lineBreak);
        js.munge = ConfigHelper.getBoolean("asset.yui.js.munge", DefaultConfig.js.munge);
        js.warn = ConfigHelper.getBoolean("asset.yui.js.warn", DefaultConfig.js.warn);
        js.preserveAllSemiColons = ConfigHelper.getBoolean("asset.yui.js.preserveAllSemiColons",
                DefaultConfig.js.preserveAllSemiColons);
        js.preserveStringLiterals = ConfigHelper.getBoolean("asset.yui.js.preserveStringLiterals",
    ...
    private static void logConfig() {
        AssetLogger.trace("enabled: %b", enabled);
        AssetLogger.trace("caching strategy: %s", cache);
        AssetLogger.trace("cache publicly clearable: %s", cacheClearEnabled);
        AssetLogger.trace("in memory storage: %s", inMemoryStorage);
        AssetLogger.trace("compression key storage time: %s", compressionKeyStorageTime);
        AssetLogger.trace("HTML compatible: %b", htmlCompatible);
        AssetLogger.trace("css source directory: %s", css.srcDir);
        AssetLogger.trace("css compressed output directory: %s", css.compressedDir);
        AssetLogger.trace("js source directory: %s", js.srcDir);
        AssetLogger.trace("js compressed output directory: %s", js.compressedDir);
        AssetLogger.trace("YUI css line break: %d", css.lineBreak);
        AssetLogger.trace("YUI js line break: %d", js.lineBreak);
        AssetLogger.trace("YUI js munge: %s", js.munge);
        AssetLogger.trace("YUI js warn: %s", js.warn);
        AssetLogger.trace("YUI js preserve all semi colons: %s", js.preserveAllSemiColons);
        AssetLogger.trace("YUI js preserve string literals: %s", js.preserveStringLiterals);
    }
