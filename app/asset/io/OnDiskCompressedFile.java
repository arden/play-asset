...
public class OnDiskCompressedFile extends CompressedFile {
    ...
    public InputStream inputStream() {
        if (!exists()) {
            throw new AssetException("Can't create InputStream. File does not exist");
        }
    ...
    public void close() {
        ...
        AssetLogger.trace(msg, tmpPath, finalPath);
        ...
        if (tmp.exists()) {
            ...
            while (tmp.exists()) {
                if (System.currentTimeMillis() - now > PluginConfig.maxCompressionTimeMillis) {
                    throw new AssetException("Timeout waiting for compressed file to be generated");
                }
    ...
    public static int clearFileCache(String compressedDir, String extension) {
        AssetLogger.trace("Deleting cached files");
        ...
        FileFilter compressedFileFilter = new AssetFileFilter(extension);
        ...
        AssetLogger.trace("Deleted %d cached files", deleted);
        return deleted;
    }
    ...
    public long length() {
        if (!exists()) {
            throw new AssetException("Can't get length. File does not exist");
        }
